    ...
    public void load() {
        ...
        try {
            ...
            generator.start()
                ...
                .key("disable-locator-bars-in-arena-worlds").defValue(true)
                .key("disable-opening-stores-of-other-teams").defValue(false)
                .key("disable-waterlogging-of-original-blocks").defValue(false)
                .key("spawn-resources-on-game-start").defValue(false)
