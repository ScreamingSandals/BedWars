...
public class TeamCommand extends BaseAdminSubCommand {
    ...
    public void construct(CommandManager<CommandSender> manager, Command.Builder<CommandSender> commandSenderWrapperBuilder) {
        ...
        manager.command(
                commandSenderWrapperBuilder
                        ...
                        .handler(commandContext -> editMode(commandContext, (sender, game) -> {
                            ...
                            var command = "/dw admin " + game.getName() + " team spawns " + team.getName() + " add";
                            sender.sendMessage(
                                    Message
        ...
        CommandExecutionHandler<CommandSender> handleTargetBlock = commandContext -> editMode(commandContext, (sender, game) -> {
            ...
            if (mode == TargetBlockSetModes.STANDING_ON) {
        ...
        manager.command(
                ...
                .literal("block")
                .argument(teamNameArgument)
                .argument(EnumArgument.optional(TargetBlockSetModes.class, "mode", TargetBlockSetModes.STANDING_ON))
        ...
        manager.command(
                commandSenderWrapperBuilder
                        ...
                        .handler((commandContext -> editMode(commandContext, (sender, game) -> {
                            ...
                            if (!chosenLoc.getBlock().block().is("#doors")) {
                                sender.sendMessage(Message.ofRichText("<red><bold>MUST BE DOOR!!!!").defaultPrefix());
                                return;
                            }
