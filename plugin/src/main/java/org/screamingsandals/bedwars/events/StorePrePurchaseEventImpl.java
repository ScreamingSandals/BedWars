...
@Data
public class StorePrePurchaseEventImpl extends CancellableAbstractEvent implements StorePrePurchaseEvent<GameImpl, BedWarsPlayer, Item, ItemSpawnerTypeImpl> {
