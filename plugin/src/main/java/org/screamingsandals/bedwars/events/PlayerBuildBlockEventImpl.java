...
@Data
public class PlayerBuildBlockEventImpl extends CancellableAbstractEvent implements PlayerBuildBlockEvent<GameImpl, BedWarsPlayer, TeamImpl, BlockHolder, BlockStateHolder, Item> {
