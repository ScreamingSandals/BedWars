...
public class GolemImpl extends SpecialItem implements Golem<Game, BedWarsPlayer, CurrentTeam, EntityLiving> {
    ...
    public GolemImpl(Game game, BedWarsPlayer player, CurrentTeam team,
