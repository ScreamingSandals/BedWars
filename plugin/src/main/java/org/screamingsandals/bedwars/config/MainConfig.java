...
public class MainConfig {
    ...
    public void load() {
        ...
        try {
            ...
            generator.start()
                .section("sounds")
                    .key("bed_destroyed").migrateOld("on_bed_destroyed").defValue("ENTITY_ENDER_DRAGON_GROWL")
                    .key("countdown").migrateOld("on_countdown").defValue("UI_BUTTON_CLICK")
                    .key("game_start").migrateOld("on_game_start").defValue("ENTITY_PLAYER_LEVELUP")
                    .key("team_kill").migrateOld("on_team_kill").defValue("ENTITY_PLAYER_LEVELUP")
                    .key("player_kill").migrateOld("on_player_kill").defValue("ENTITY_PLAYER_BIG_FALL")
                    .key("item_buy").migrateOld("on_item_buy").defValue("ENTITY_ITEM_PICKUP")
                    .key("upgrade_buy").migrateOld("on_upgrade_buy").defValue("ENTITY_EXPERIENCE_ORB_PICKUP")
                    .key("respawn_cooldown_wait").migrateOld("on_respawn_cooldown_wait").defValue("UI_BUTTON_CLICK")
                    .key("respawn_cooldown_done").migrateOld("on_respawn_cooldown_done").defValue("ENTITY_PLAYER_LEVELUP")
                    .back()
