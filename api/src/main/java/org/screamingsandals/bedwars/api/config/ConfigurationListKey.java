...
/**
 *
 * @param <T> type of the member of the list
 * @author ScreamingSandals
 * @since 0.3.0
 */
@Data
@RequiredArgsConstructor(access = AccessLevel.PRIVATE)
public class ConfigurationListKey<T> {
    ...
    /**
     *
     * @param type type of the list member, please don't use primitives!
    ...
    public static <T> ConfigurationListKey<T> of(@NotNull Class<T> type, @NotNull String... keys) {
    ...
    @NotNull
    @Contract(value = "_, _ -> new", pure = true)
    public static <T> ConfigurationListKey<T> of(@NotNull Class<T> type, @NotNull List<@NotNull String> keys) {
        ...
        return new ConfigurationListKey<>(keys, type);
    }
}
