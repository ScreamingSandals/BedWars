...
public interface PostTargetInvalidatedEvent {
    ...
    static void handle(Object plugin, Consumer<PostTargetInvalidatedEvent> consumer) {
        BedwarsAPI.getInstance().getEventUtils().handle(plugin, PostTargetInvalidatedEvent.class, consumer);
    }
}
